...
python scripts/ld_prune.py --gwas gwas/gwas_combine_standard/${exposure}.gwas.pheno.glm.linear --bfile filter4 --gwas_thresh 0.00000005 --prune_thresh 0.1 --temp_basename ${exposure} --out pruned/${exposure}.prune
#
