...
cat "egger results:" >> ${outname}
python scripts/run_mrtwin_real_data.py --basename ${intermed_dir}${pairname} --method egger >> ${outname}
#cat "mode results:" >> ${outname}
#python scripts/run_mrtwin_real_data.py --basename ${intermed_dir}${pairname} --method mode >> ${outname}
cat "median results:" >> ${outname}
python scripts/run_mrtwin_real_data.py --basename ${intermed_dir}${pairname} --method median >> ${outname}
cat "brumpton results:" >> ${outname}
Rscript scripts/brumpton.R ${intermed_dir}${pairname} ${num_sims} >> ${outname}
#
