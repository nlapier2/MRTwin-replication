...
if __name__ == '__main__':
    ...
    mr_res = mrtrio.mrtrio(pa1geno, pa2geno, child1_geno, child1_o, beta_e, se_e, beta_o, se_o,
                           num_twins=main_args.num_twins, mr_method=main_args.method)
    if main_args.include_duo:
        mr_duo_res = mrtrio.mrtrio_new(beta_e, se_e, beta_o, se_o, child1_o, par1_geno=pa1geno, child_geno=child1_geno,
                                       num_twins=main_args.num_twins, mr_method=main_args.method)
